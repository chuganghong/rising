...
listTable.GraphicDesign = function()
{
  this.query="GraphicDesign";
  GraphicDesign();
  this.filter['page'] = 1;
  var args = "act="+this.query+"" + this.compileFilter();
  this.url='index.php?is_ajax=1';
...
listTable.listCallback = function(result, txt)
{
  ...
  else
  {
    try
    {
      document.getElementById('onepages').innerHTML = result.content;
