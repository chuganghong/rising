	...
	$.validationEngineLanguage = {
		newLang : function() {
			$.validationEngineLanguage.allRules = {
				...
				"ajaxCompanyName" : {
					"file" : "member.php?act=ajaxCompanyName",
					"alertTextOk" : "* 公司名可以使用.",
					"alertTextLoad" : "* 检查中, 请稍后...",
					"alertText" : "* 公司名不能使用."
				},
				"ajaxMemberUser" : {
					"file" : "member.php?act=ajaxMemberUser",
				...
				"ajaxMemberUserS" : {
					"file" : "member.php?act=ajaxMemberUserS",
					"alertTextOk" : "* 身份证可以使用.",
					"alertTextLoad" : "* 检查中, 请稍后...",
					"alertText" : "* 身份证不能使用."
				},
				"ajaxMemberPass" : {
					"file" : "member.php?act=ajaxMemberPass&id="+$("#m_id").val(),
					"alertTextOk" : "* 密码输入正确.",
					"alertTextLoad" : "* 检查中, 请稍后...",
					"alertText" : "* 密码不匹配."
				},
