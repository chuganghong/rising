...
class Trends_Detail extends CI_Controller {
    ...
    {      
		...
		$cur = 3;    //在取出的top topic数组中，join栏目的key为3
		...
		$this->load->model('Trends_detail_model');	
		...
		$content = $this->Trends_detail_model->get_content($case_id);   //文章数据	
