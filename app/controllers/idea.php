...
class Idea extends CI_Controller {
    ...
    {      
		...
		$cat_desc = $this->Idea_model->get_desc($cur2);
		...
		//content
		$case_id = 4;   //在sd_case_about table中“日先理念“的ID是4
		$idea_content = $this->Idea_model->get_content($case_id);
		$data['idea_content'] = $idea_content[0]['content'];
		
		//新闻会客室
		$cat_id2 = 9;   //在sd_case_cat table中“日先理念“的ID是9
