...
class Trends extends CI_Controller {
	public function view($page = 'trends')
    {      
		...
		$url_detail = 'http://127.0.0.1/rising/index.php/trends_detail/view/detail/5/12/';
		...
		$url = 'http://127.0.0.1/rising/index.php/trends/view/trends/5/12/';		
