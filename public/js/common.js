...
$(document).ready(function()
{
	$("#sbook").click(function()
	{
		...
		if( (!username) || (!company) || (!job) || (!phone) || (!email) )
		{
			var msg1 = '请将所有资料填写完整！';
			alert(msg1);
			return true;
		...
		var msg2 = "请填写正确的电话号码！";
		var pattern8 = /\d{8}/;   //匹配8个数字
		alert(phone.match(pattern8));
		var pattern11 = /\d{11}/;    //匹配11个数字
		if(phone.match(pattern8)===null || phone.match(pattern11)==null)
		{
			alert(msg2);		
			return true
		}
