<?php /* Smarty version 2.6.14, created on 2013-12-18 10:43:08
         compiled from trends2_list.html */ ?>
...
" /> <?php echo $this->_tpl_vars['Case'][$this->_sections['por']['index']]['Case_id']; ?>
      ...
      <a href="trends2.php?act=edit&Case_id=<?php echo $this->_tpl_vars['Case'][$this->_sections['por']['index']]['Case_id']; ?>
">编辑</a> | 
...
, '您确认要删除这条记录吗?')" title="删除">移除</a> |
	   <a href="trends2.php?act=send&user_id=<?php echo $this->_tpl_vars['Case'][$this->_sections['por']['index']]['Case_id']; ?>
">发送</a> |
	  <a href="trends2.php?act=send_no&user_id=<?php echo $this->_tpl_vars['Case'][$this->_sections['por']['index']]['Case_id']; ?>
">不发送</a>
	  </td>
    </tr>
    <?php endfor; else: ?>
