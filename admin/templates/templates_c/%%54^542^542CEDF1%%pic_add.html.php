<?php /* Smarty version 2.6.14, created on 2013-12-12 17:06:28
         compiled from pic_add.html */ ?>
...
<div class="main-div">
<form action="pic.php" id="theForm" name="theForm" method="post" enctype="multipart/form-data">
<table cellspacing="1" cellpadding="3" width="90%">
  ...
  <tr>
    ...
    <td><input type="file" name="img_file_src2" value="" size="40" />
    <br /><span class="notice-span">此模板的图片标准宽度为：138 标准高度为：61</span>
    <?php if ($this->_tpl_vars['row']['thumb_src']): ?>
    <br /><img src="../<?php echo $this->_tpl_vars['row']['thumb_src']; ?>
" width="186" height="61" />
    <input type="hidden" name="thumb_src" value="<?php echo $this->_tpl_vars['row']['thumb_src']; ?>
" />
    <?php endif; ?>
    </td>
  </tr>
  <tr>
    ...
    <br /><span class="notice-span">此模板的图片标准宽度为：691 标准高度为：344</span>
