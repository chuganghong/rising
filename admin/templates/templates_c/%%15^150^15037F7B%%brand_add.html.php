<?php /* Smarty version 2.6.14, created on 2013-12-11 18:22:28
         compiled from brand_add.html */ ?>
...
<div class="main-div">
<form action="works.php" id="theForm" name="theForm" method="post" enctype="multipart/form-data">
...
" size="40" /></td>
  ...
  <tr>
    ...
    <br /><span class="notice-span"><?php echo $this->_tpl_vars['msg']; ?>
</span>
...
" />
  ...
  <tr>
    ...
    <td>
		<textarea rows="10" cols="38" name="img_alt_tw"><?php echo $this->_tpl_vars['row']['img_alt_tw']; ?>
</textarea>
		<!--<input name="img_alt_tw" type="text" value="<?php echo $this->_tpl_vars['row']['img_alt_tw']; ?>
" size="40" />-->
	</td>
  </tr>
  <!--
  <tr>
    ...
    <td> <label><input name="img_type" type="radio" class="typeid" value="1" <?php if ($this->_tpl_vars['row']['img_type'] == 1): ?>checked="checked"<?php endif; ?>/>BANNER</label>
            <label><input name="img_type" type="radio" class="typeid" value="0" <?php if ($this->_tpl_vars['row']['img_type'] == 0): ?>checked="checked"<?php endif; ?>/>其他</label></td>
  </tr>
...
" />
	  <input type="hidden"  name="bc"       value="<?php echo $this->_tpl_vars['bc']; ?>
" />
