<?php /* Smarty version 2.6.14, created on 2013-12-18 15:35:21
         compiled from email_info.html */ ?>
...
<form action="" method="post" name="theForm" id="theForm" enctype="multipart/form-data">
  <table width="100%" border="0" cellspacing="2" cellpadding="2">    
    <tr>
      <td class="label">邮件发送协议：</td>
      <td><input type="text" name="protocol" id="protocol" value="<?php echo $this->_tpl_vars['row']['protocol']; ?>
...
"  class="validate[required]" /><font color="red"> *请输入完整的Email帐号 </font></td>
    </tr>
