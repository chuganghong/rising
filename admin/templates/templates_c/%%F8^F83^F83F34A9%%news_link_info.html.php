<?php /* Smarty version 2.6.14, created on 2013-12-17 14:38:32
         compiled from news_link_info.html */ ?>
...
" /><br />
	...
	<tr>
        ...
        <br /><span class="notice-span">此模板的图片标准宽度为：185 标准高度为：101</span>
        <?php if ($this->_tpl_vars['row']['pic']): ?>
        <br /><img src="../<?php echo $this->_tpl_vars['row']['pic']; ?>
" width="186" height="61" />
        <input type="test" name="cat_pic" value="<?php echo $this->_tpl_vars['row']['pic']; ?>
" />
        <?php endif; ?>
        </td>
      </tr>
...
" />
	<input type="hidden" name="parent_id" value="<?php echo $this->_tpl_vars['row']['parent_id']; ?>
" />
</form>
</div>
<?php echo '
