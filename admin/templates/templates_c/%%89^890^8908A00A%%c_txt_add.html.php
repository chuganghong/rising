<?php /* Smarty version 2.6.14, created on 2013-12-16 12:11:12
         compiled from c_txt_add.html */ ?>
...
" style="width:400px" /></td>
    ...
    <tr>
        ...
        <br /><span class="notice-span">此模板的图片标准宽度为：108 标准高度为：98</span>
...
" />
	...
	<tr>
      <td align="left" class="label">摘要：</td>
      <td><textarea name="describe" rows="6" cols="60"><?php echo $this->_tpl_vars['row']['content_en']; ?>
</textarea></td>
    </tr>
	-->
    <tr>
...
" />
	<input name="cat_id" type="hidden" id="cat_id" value="<?php echo $this->_tpl_vars['cat_id']; ?>
" />
