<?php /* Smarty version 2.6.14, created on 2013-12-12 15:51:31
         compiled from album_list.html */ ?>
...
">
	<!--
	    <td><?php echo $this->_tpl_vars['Caseloca'][$this->_sections['por']['index']]['cat_name']; ?>
&nbsp;</td>
     <td><?php echo $this->_tpl_vars['Caseloca'][$this->_sections['por']['index']]['action_name']; ?>
</td>
     <td><img src="images/<?php if ($this->_tpl_vars['Caseloca'][$this->_sections['por']['index']]['show_in_nav'] == 0): ?>no<?php else: ?>yes<?php endif; ?>.gif" border="0" /></td>
...
em" onclick="rowClicked(this)" />
     ...
     <td><?php echo $this->_tpl_vars['Caseloca'][$this->_sections['por']['index']]['sort_order']; ?>
      ...
      <td>
      <a href="album.php?act=edit&cat_id=<?php echo $this->_tpl_vars['Caseloca'][$this->_sections['por']['index']]['cat_id']; ?>
">编辑</a> | 
	  <a href="pic.php?act=list&cat_id=<?php echo $this->_tpl_vars['Caseloca'][$this->_sections['por']['index']]['cat_id']; ?>
">管理</a> | 
