<?php /* Smarty version 2.6.14, created on 2013-12-18 10:34:01
         compiled from trends_list.html */ ?>
...
<form method="POST" action="trends.php?act=batch_drop" name="listForm">
...
" /> <?php echo $this->_tpl_vars['Case'][$this->_sections['por']['index']]['Case_id']; ?>
	  ...
	  <td><?php if ($this->_tpl_vars['Case'][$this->_sections['por']['index']]['issend']): ?>是<?php else: ?>否<?php endif; ?></td> 
      <td align="center">
    
      <a href="trends.php?act=edit&Case_id=<?php echo $this->_tpl_vars['Case'][$this->_sections['por']['index']]['Case_id']; ?>
">编辑</a> | 
...
, '您确认要删除这条记录吗?')" title="删除">移除</a> |
	   <a href="trends.php?act=send&user_id=<?php echo $this->_tpl_vars['Case'][$this->_sections['por']['index']]['Case_id']; ?>
">发送</a> |
	  <a href="trends.php?act=send_no&user_id=<?php echo $this->_tpl_vars['Case'][$this->_sections['por']['index']]['Case_id']; ?>
">不发送</a>
	  </td>
    </tr>
    <?php endfor; else: ?>
