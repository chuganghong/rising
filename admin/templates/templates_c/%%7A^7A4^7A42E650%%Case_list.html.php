...
<form method="POST" action="Case.php?act=batch_drop" name="listForm">
...
" /> <?php echo $this->_tpl_vars['Case'][$this->_sections['por']['index']]['Case_id']; ?>
      ...
      <a href="Case.php?act=edit&Case_id=<?php echo $this->_tpl_vars['Case'][$this->_sections['por']['index']]['Case_id']; ?>
">编辑</a> | 
